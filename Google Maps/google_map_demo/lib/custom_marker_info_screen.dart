...
class CustomMarkerInfoScreen extends StatefulWidget {
  const CustomMarkerInfoScreen({super.key});

  @override
  State<CustomMarkerInfoScreen> createState() => _CustomMarkerInfoScreenState();
}

class _CustomMarkerInfoScreenState extends State<CustomMarkerInfoScreen> {
